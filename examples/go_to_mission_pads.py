...
async def main():
    ...
    try:
        ...
        output_state()
        await drone.go_to(relative_position=Vector(150, 0, 100), speed=25, mission_pad=1)
        output_state()
        await drone.go_to(relative_position=Vector(0, 0, 100), speed=25, mission_pad=2)
        output_state()
        await drone.go_to(relative_position=Vector(150, 0, 100), speed=25, mission_pad=2)
        output_state()
